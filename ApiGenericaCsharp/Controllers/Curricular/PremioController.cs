...
namespace ApiProyecto.Controllers.Curricular
{
    ...
    public class PremioController : BaseController
    {
        ...
        {
            var lista = await _context.Premios.ToListAsync();
        ...
        [HttpPost]
        public async Task<ActionResult> Post(Premio item)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Premio item)
        {
        ...
        [HttpPut("{campo}/{valor}")]
        public async Task<IActionResult> PutPorCampo(string campo, string valor, Premio item)
        {
