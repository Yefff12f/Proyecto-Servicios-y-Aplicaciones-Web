...
namespace ApiProyecto.Controllers.Curricular
{
    ...
    public class ProgramaController : BaseController
    {
        ...
        public ProgramaController(AppDbContext context) { _context = context; }

        [HttpGet]
        public async Task<ActionResult> Get()
        {
            var lista = await _context.Programas.ToListAsync();
        ...
        [HttpPost]
        public async Task<ActionResult> Post(Programa item)
        {
        ...
        [HttpPut("{campo}/{valor}")]
        public async Task<IActionResult> PutPorCampo(string campo, string valor, Programa item)
        {
