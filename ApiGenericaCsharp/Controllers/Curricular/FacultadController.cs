...
namespace ApiProyecto.Controllers.Curricular
{
    ...
    public class FacultadController : ControllerBase
    {
        ...
        public FacultadController(AppDbContext context) { _context = context; }

        [HttpGet]
        public async Task<ActionResult> Get()
        {
            var lista = await _context.Facultades.ToListAsync();
        ...
        {
            var item = await _context.Facultades.FindAsync(id);
            if (item == null) return NotFound();
            return Ok(item);
        }

        [HttpPost]
        public async Task<ActionResult> Post(Facultad item)
        {
        ...
        [HttpPut("{campo}/{valor}")]
        public async Task<IActionResult> PutPorCampo(string campo, string valor, Facultad item)
        {
