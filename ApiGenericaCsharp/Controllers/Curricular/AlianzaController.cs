...
namespace ApiProyecto.Controllers.Curricular
{
    ...
    public class AlianzaController : ControllerBase
    {
        ...
        {
            var item = await _context.Alianzas.FindAsync(id);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Alianza item)
        {
        ...
        [HttpPut("{campo}/{valor}")]
        public async Task<IActionResult> PutPorCampo(string campo, string valor, Alianza item)
        {
