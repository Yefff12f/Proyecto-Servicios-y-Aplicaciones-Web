...
using ProyectoModel = ApiProyecto.Models.conocimiento.Proyecto;
...
namespace ApiProyecto.Controllers.Conocimiento
{
    ...
    public class ProyectoController : BaseController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Post(ProyectoModel item)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, ProyectoModel item)
        {
        ...
        [HttpPut("{campo}/{valor}")]
        public async Task<IActionResult> PutPorCampo(string campo, string valor, ProyectoModel item)
        {
