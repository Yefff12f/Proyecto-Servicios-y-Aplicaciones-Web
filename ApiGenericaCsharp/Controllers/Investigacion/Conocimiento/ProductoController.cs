...
namespace ApiProyecto.Controllers.conocimiento
{
    ...
    public class ProductoController : ControllerBase
    {
        ...
        {
            return Ok(new { datos = await _context.Productos.ToListAsync() });
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Post(Producto item)
        {
        ...
        [HttpPut("{campo}/{valor}")]
        public async Task<IActionResult> PutPorCampo(string campo, string valor, Producto item)
        {
